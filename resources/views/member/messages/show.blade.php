       ...
       <div class="modal-dialog">
    	...
    	<div class="modal-content">
    		...
    		<div class="modal-body">
    			<form action="{{url('member/messages/reply')}}" method="post">
                {{ csrf_field() }}
                  <div class="box-body">
                      ...
                      <div class="form-group hidden">
                        <label>To :</label>
                        <input type="text" name="to" class="form-control" value="{{ $induk_messages->to }}" readonly>
                     </div>
                 ...
                 <div class="modal-footer">
                    <button type="submit" class="btn custom__btn-greenHover">Balas</button>
        		</div>
               </form>
    		</div>
    	</div>
