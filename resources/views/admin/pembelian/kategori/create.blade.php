        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title"><a href="{{route('pembelian-kategori.index')}}" class="hidden-lg btn-loading"><i class="fa fa-arrow-left" style="margin-right:10px;"></i></a>Tambah Kategori</h3>
                </div>
                <form role="form" action="{{route('pembelian-kategori.store')}}" method="post">
                {{csrf_field()}}
                    <div class="box-body">
                        <div class="form-group{{ $errors->has('product_id') ? ' has-error' : '' }}">
                            <label>ID Kategori (Server) : </label>
                            <input type="text" class="form-control" name="product_id"  placeholder="Masukkan ID Kategori Server">
                        ...
                        <div class="form-group{{ $errors->has('icon') ? ' has-error' : '' }}">
                            <label>Icon Kategori (<a href="https://fontawesome.io/icons/">fontawesome.io</a>) : </label>
            ...
            <div class="box box-solid box-penjelasan">
                ...
                <div class="box-body table-responsive no-padding">
                    <table class="table table-hover">
                        ...
                        @foreach($kategori_server->data as $data)
                        <tr>
                            <td>{{$data->id}}</td>
