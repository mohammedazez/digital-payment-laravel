...
<section class="content-header hidden-xs hidden-sm">
	<h1>Pembelian <small>Produk</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Data Produk</h3><button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false" style="padding: 3px 7px;margin-left:5px;"><i class="fa fa-trash"></i><span class="hidden-xs hidden-sm"> Hapus Semua Data Produk</span></button>
                </div><!-- /.box-header -->
