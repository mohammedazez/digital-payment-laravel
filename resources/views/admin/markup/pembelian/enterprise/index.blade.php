...
<section class="content-header hidden-xs hidden-sm">
	<h1>Pembelian <small>Produk (Level Enterprise)</small></h1>
    <ol class="breadcrumb">
                    ...
                    <table id="DataTable" class="table table-hover" style="margin-bottom:20px;">
                        ...
                        <tbody>
                            ...
                            <tr style="font-size: 13px;">
                                ...
                                @endif
                                <td>
                                    <form method="POST" action="{{ route('admin.produkEnterprise.delete', $produk->id) }}" accept-charset="UTF-8">
...
<script type="text/javascript">
    ...
    $('#proses').on('click', function(){
        ...
        $.ajax({
            url: '/admin/pembelian-produk/markup/role-enterprise/delete',
            type: "post",
            data: {
                '_token': '{{csrf_token()}}',
            },
