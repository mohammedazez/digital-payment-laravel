...
<ol class="breadcrumb">
  <li><a href="{{url('/admin')}}" class="btn-loading"><i class="fa fa-dashboard"></i> Home</a></li>
    ...
    <li><a href="{{url('/admin/pembelian-produk/markup/role-agen')}}"> Produk</a></li>
                       ...
                       <div class="box">
                          <div class="box-header with-border">
                             ...
                             <div class="box-tools pull-right">
                                  <a href="{{url('/admin/pembelian-produk/markup/role-agen')}}" class="btn btn-primary btn-sm">Home Produk</a>
                              </div>
                          </div><!-- /.box-header -->
                          ...
                          <h4 style="font-weight: bold;text-align: center;">{{$data->product_name}}</h4>
                            <div class="box-body table-responsive no-padding">
                               ...
                               <thead>
                                  ...
                                  @foreach($data->V_pembelianproduk_agen as $produk)
                                  <tr style="font-size: 13px;">
                                     ...
                                     @endif
                                     <td>
                                        <a href="{{url('/admin/pembelian-produk/markup/role-agen/'.$kategori->slug.'/edit', $produk->id)}}" class="btn-loading btn btn-primary btn-sm" style="padding: 2px 5px;font-size: 10px;"><i class="fa fa-pencil-square-o fa-fw"></i>Ubah Harga</a>
                                     </td>
                                  </tr>
                                  @endforeach
                                  @else
                      ...
                      <div class="col-xs-12">
                          <div class="box">
                              <div class="box-header">
                                  <h3 class="box-title" style="font-size:18px;"><a href="{{url('/admin/pembelian-produk/markup/role-agen')}}" class="hidden-lg btn-loading"><i class="fa fa-arrow-left" style="margin-right:10px;"></i></a>{{$kategori->product_name}}</h3>
                             <div class="box-tools pull-right">
                                  ...
                                  <table class="table table-hover">
                                      ...
                                      <tr>
                                          ...
                                          <td align="right" style="width:35%;">
                                              ...
                                              @endif
                                              <div style="margin-top:5px;"><a href="{{url('/admin/pembelian-produk/markup/role-agen/'.$kategori->slug.'/edit', $produk->id)}}" class="btn-loading btn btn-primary btn-sm" style="padding: 2px 5px;font-size: 10px;">Ubah Harga</a></div>
                                          </td>
                                      </tr>
                                      @endforeach
                                      @else
...
// $(document).ready(function() {
    ...
    $('#proses').on('click', function(){
       ...
       $.blockUI({ css: { 
        ...
        if(val_radio =='option_data'){
          $.ajax({
              url: '{{ url('/admin/pembelian-produk/markup/role-agen/plusminusmarkup') }}?aksi='+aksi+'&nominal='+nominal+'type={{$kategori->id}}',
              type: "GET",
          ...
          $.ajax({
                type: "POST",
                url: "{{ url('/admin/pembelian-produk/markup/role-agen/plusminusmarkupAllData') }}",
    ...
    {    
       ...
       $.ajax({
            type: "GET",
            url: "{{ url('admin/pembelian-produk/markup/role-agen/cek-harga') }}",
    ...
    function updateHargaSemua()
    {
      $.blockUI({ css: { 
       ...
       $.ajax({
            type: "GET",
            url: "{{ url('admin/pembelian-produk/markup/role-agen/update-harga-semua') }}",
            success: function(response){
              if(response.success == true)
              {
                  $.unblockUI();
    ...
    function updateHargaPerOperator($kategori)
    {
      ...
      $.blockUI({ css: { 
       ...
       $.ajax({
            type: "GET",
            url: "{{ url('/admin/pembelian-produk/markup/role-agen/update-harga-peroperator') }}?id_operator="+id_operator+"&id_kategori="+id_kategori+"",
            success: function(response){
              if(response.success == true)
              {
                  $.unblockUI();
    ...
    function updateHargaPerKategori(){
      ...
      $.blockUI({ css: { 
       ...
       $.ajax({
            type: "GET",
            url: "{{ url('/admin/pembelian-produk/markup/role-agen/update-harga-perkategori') }}?id_kategori="+id_kategori,
            success: function(response){
              if(response.success == true)
              {
                  $.unblockUI();
    ...
    function sumMarkingByKategori()
    {
      ...
      $.blockUI({ css: { 
       ...
       $.ajax({
            type: "POST",
            url: "{{ url('admin/pembelian-produk/markup/role-agen/update-harga-sum-markup-bykategori') }}",
    ...
    function sumMarkingByOperator()
    {
      ...
      $.blockUI({ css: { 
       ...
       $.ajax({
            type: "GET",
            url: "{{ url('admin/pembelian-produk/markup/role-agen/update-harga-sum-markup-byoperator') }}",
  ...
  $('#pilih_kategori').on('change', function(e){
   ...
   $.ajaxSetup({
        ...
        $.ajax({
            url: "{{ url('/admin/pembelian-produk/markup/role-agen/process-cari/findproduct') }}",
            dataType: "json",
            type: "GET",
            data: {
