...
<section class="content-header hidden-xs hidden-sm">
	<h1>Produk <small>{{$produks->pembeliankategori->product_name}} Level Agen</small></h1>
    <ol class="breadcrumb">
    	<li><a href="{{url('/admin')}}" class="btn-loading"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="Javascript:;">Pembelian</a></li>
        <li><a href="{{url('/admin/pembelian-produk/markup/role-agen', $produks->pembeliankategori->slug)}}" class="btn-loading"> Produk {{$produks->pembeliankategori->product_name}} Level Agen</a></li>
    ...
    <div class="row">   
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title"><a href="{{url('/admin/pembelian-produk/markup/role-agen', $produks->pembeliankategori->slug)}}" class="hidden-lg btn-loading"><i class="fa fa-arrow-left" style="margin-right:10px;"></i></a>Ubah Harga Produk</h3>
                </div>
                <form role="form" action="{{url('/admin/pembelian-produk/markup/role-agen/update', $produks->id)}}" method="post">
