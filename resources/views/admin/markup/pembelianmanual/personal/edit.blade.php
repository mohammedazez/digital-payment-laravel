...
<section class="content-header hidden-xs hidden-sm">
	<h1>Produk <small>{{$produks->pembelianmanualkategori->product_name}} Level Personal</small></h1>
    <ol class="breadcrumb">
    	<li><a href="{{url('/admin')}}" class="btn-loading"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="Javascript:;">Pembelian Manual</a></li>
        <li><a href="{{url('/admin/pembelianmanual-produk/markup/role-personal', $produks->pembelianmanualkategori->slug)}}" class="btn-loading"> Produk {{$produks->pembelianmanualkategori->product_name}} Level Personal</a></li>
    ...
    <div class="row">      
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title"><a href="{{url('/admin/pembelianmanual-produk/markup/role-personal', $produks->pembelianmanualkategori->slug)}}" class="hidden-lg btn-loading"><i class="fa fa-arrow-left" style="margin-right:10px;"></i></a>Ubah Harga Produk</h3>
                </div>
                <form role="form" action="{{url('/admin/pembelianmanual-produk/markup/role-personal/update', $produks->id)}}" method="post">
