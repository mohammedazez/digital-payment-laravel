...
<section class="content-header hidden-xs hidden-sm">
	<h1>Pembelian Manual<small>Produk (Level Enterprise)</small></h1>
    <ol class="breadcrumb">
    	<li><a href="{{url('/admin')}}" class="btn-loading"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="Javascript:;">Pembelian Manual</a></li>
    	<li class="active">Produk (Level Enterprise)</li>
    </ol>
</section>
        ...
        <div class="col-md-12">
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Data Produk (Level Enterprise)</h3><button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false" style="padding: 3px 7px;margin-left:5px;"><i class="fa fa-trash"></i><span class="hidden-xs hidden-sm"> Hapus Semua Data Produk</span></button>
                </div><!-- /.box-header -->
                    ...
                    <table class="table table-hover">
                        ...
                        <tr>
                            <td>
                                ...
                                <div style="font-size: 14px;font-weight: bold;">{{$data->pembelianmanualoperator->product_name}} - {{$data->product_name}}</div>
                                <div>{{$data->pembelianmanualkategori->product_name}}</div>
                            </td>
...
<script type="text/javascript">
    ...
    $('#proses').on('click', function(){
        ...
        $.ajax({
            url: '/admin/pembelianmanual-produk/markup/role-enterprise/delete',
            type: "post",
            data: {
                '_token': '{{csrf_token()}}',
            },
