...
<section class="content-header hidden-xs hidden-sm">
	<h1>Produk <small>{{$produks->pembelianmanualkategori->product_name}} Level Enterprise</small></h1>
    <ol class="breadcrumb">
    	<li><a href="{{url('/admin')}}" class="btn-loading"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="Javascript:;">Pembelian Manual</a></li>
        <li><a href="{{url('/admin/pembelianmanual-produk/markup/role-enterprise', $produks->pembelianmanualkategori->slug)}}" class="btn-loading"> Produk {{$produks->pembelianmanualkategori->product_name}} Level Enterprise</a></li>
    ...
    <div class="row">      
        <div class="col-md-6">
            <div class="box box-solid box-penjelasan">
                <div class="box-header">
                    ...
                    <h3 class="box-title">Detail Produk {{$produks->product_name}}</h3>
                ...
                <div class="box-body">
                    <table class="table">
                        ...
                        <tr>
                            <td>Operator</td>
                            <td>:</td>
                            <td>{{$produks->pembelianmanualoperator->product_name}}</td>
                        </tr>
                        <tr>
                            <td>Kategori</td>
                            <td>:</td>
                            <td>{{$produks->pembelianmanualkategori->product_name}}</td>
                        </tr>
                        <tr>
                            <td>Harga Default</td>
                            <td>:</td>
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title"><a href="{{url('/admin/pembelianmanual-produk/markup/role-enterprise', $produks->pembelianmanualkategori->slug)}}" class="hidden-lg btn-loading"><i class="fa fa-arrow-left" style="margin-right:10px;"></i></a>Ubah Harga Produk</h3>
                </div>
                <form role="form" action="{{url('/admin/pembelianmanual-produk/markup/role-enterprise/update', $produks->id)}}" method="post">
